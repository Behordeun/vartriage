...
class TestGeneOverlapClassification:
    ...
    def test_whole_gene_deletion(self) -> None:
        ...
        annotator._genes = {
            "chr1": [GeneRecord("BRCA1", "chr1", 1000, 4000, "+", 23)]
        }
        annotator._dosage = {}
    ...
    def test_partial_gene_deletion(self) -> None:
        ...
        annotator._genes = {
            "chr1": [GeneRecord("TP53", "chr1", 1000, 10000, "+", 11)]
        }
        annotator._dosage = {}
    ...
    def test_whole_gene_duplication(self) -> None:
        annotator = SVAnnotator(whole_gene_threshold=0.8)
        annotator._genes = {
            "chr1": [GeneRecord("MYC", "chr1", 2000, 3000, "+", 3)]
        }
        annotator._dosage = {}
    ...
    def test_gene_disruption_for_inversion(self) -> None:
        annotator = SVAnnotator(whole_gene_threshold=0.8)
        annotator._genes = {
            "chr1": [GeneRecord("NF1", "chr1", 2000, 4000, "+", 58)]
        }
        annotator._dosage = {}
    ...
    def test_intergenic_when_no_gene_overlap(self) -> None:
        annotator = SVAnnotator(whole_gene_threshold=0.8)
        annotator._genes = {
            "chr1": [GeneRecord("FAR", "chr1", 50000, 60000, "+", 5)]
        }
        annotator._dosage = {}
    ...
    def test_cnv_loss_classified_as_deletion(self) -> None:
        annotator = SVAnnotator(whole_gene_threshold=0.8)
        annotator._genes = {
            "chr1": [GeneRecord("RB1", "chr1", 2000, 3000, "+", 27)]
        }
        annotator._dosage = {}
    ...
    def test_cnv_gain_classified_as_duplication(self) -> None:
        annotator = SVAnnotator(whole_gene_threshold=0.8)
        annotator._genes = {
            "chr1": [GeneRecord("ERBB2", "chr1", 2000, 3000, "+", 31)]
        }
        annotator._dosage = {}
...
class TestChromNormalization:
    ...
    def test_sv_with_chr_matches_genes_with_chr(self) -> None:
        annotator = SVAnnotator(whole_gene_threshold=0.8)
        annotator._genes = {
            "chr1": [GeneRecord("X", "chr1", 2000, 3000, "+", 5)]
        }
        annotator._dosage = {}
